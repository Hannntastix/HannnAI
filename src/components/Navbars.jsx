        ...
        <Navbar rounded className="bg-black">
            <Navbar.Brand as={Link} to="#">
                <img
                    ...
                    className="mr-5 h-9 sm:h-9"
                    alt="AI"
                />
                <span className="self-center whitespace-nowrap text-xl font-semibold text-gray-400 font-mono">
                    HannnAI 2.0
                </span>
            </Navbar.Brand>
            <Navbar.Toggle />
            <Navbar.Collapse>
                {isAuth ? (
                    <>
                        ...
                        <Navbar.Link
                            target="_blank"
                            href="https://tictactoe-hannnai.vercel.app/"
                            active={location.pathname === "https://tictactoe-hannnai.vercel.app/"}
                        >
                            Play Game
                        </Navbar.Link>
                        <button
                            onClick={logout}
                            type="button"
                            className="text-indigo-700 hover:text-indigo-950 bg-none"
                        >
                            Sign Out
                        </button>
                    </>
