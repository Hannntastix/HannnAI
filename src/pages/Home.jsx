...
const Home = () => {
    return (
        <>
            <main className='w-full bg-black justify-center items-center md:h-screen h-[60vh] md:justify-center md:items-center flex-grow'>
                <div className='flex md:flex-row flex-col mb-20 md:gap-10 gap-5 justify-center items-center h-screen w-full'>
                    <div className='md:w-3/6 text-left px-5'>
                        ...
                        <Typewriter text="Hello, Welcome to HannAI, a website contains an AI supported by Llama3. You can ask anything to HannnAI by go to explore 
